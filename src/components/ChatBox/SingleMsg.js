		...
		<div className="single-msg">
			<div className="single-msg-box">
				<div className="single-msg-profile">
					<div className="user-profile-pic"><img className="img-round" src="https://previews.123rf.com/images/demkat/demkat1602/demkat160200082/52934624-a-single-white-glazed-donut-with-sprinkles-isolated-white-background.jpg"/></div>
